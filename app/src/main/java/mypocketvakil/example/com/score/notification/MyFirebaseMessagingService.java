package mypocketvakil.example.com.score.notification;
...
/**
 * Created by sanyam jain on 03-12-2016.
 */
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                Intent resultIntent = new Intent(getApplicationContext(), Info_wall.class);
